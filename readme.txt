...
Contributors: iCaleb
Tags: woocommerce, ecommerce, e-commerce, commerce, wordpress ecommerce, store, product, fees, surcharge, additional fees, product based fees
...
A WooCommerce plugin that adds a product settings tab for creating additional fees that show up at checkout based on if that product is in the cart.
...
For help setting up and configuring this plugin, please refer to the [WooCommerce Product Fees GitHub Repository](#).
...
Feel free to submit a feature request as an issue at the [WooCommerce Product Fees GitHub Repository](#).

= Where can I report bugs or contribute to the project? =

Bugs can be reported either in our support forum or preferably on the [WooCommerce Product Fees GitHub Repository](#).

= WooCommerce is awesome! Can I contribute? =

Yes you can! Join in at the [WooCommerce Product Fees GitHub Repository](#)
